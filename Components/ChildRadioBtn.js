    ...
    render() {   
        ...
        >
            ...
            {this.props.radio_props.map((obj, i) => (
                ...
                obj={obj}
                index={i}
                onPress={(value) => this.props.SelectRadioBtn(this.props.valueName, value)}
                ...
                buttonSize={15}
                buttonOuterSize={20}
                buttonStyle={this.props.valueName === i ? {backgroundColor: 'gray'} : {backgroundColor: 'white'}}
                buttonWrapStyle={{marginLeft: 10, backgroundColor: 'white',
