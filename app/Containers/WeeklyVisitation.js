...
import { TouchableOpacity, ScrollView, TextInput, ImageBackground, Image, StyleSheet, Text, View, CheckBox } from 'react-native';
...
export default class WeeklyVisitation extends Component {
  constructor(props) {
    super(props)
    this.state = {
      child_id: this.props.childsID[0]['child_id'],
      selectedDays: {
        selectedMunRadioBtn: { week_day: 1, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedTueRadioBtn: { week_day: 2, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedWedRadioBtn: { week_day: 3, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedThuRadioBtn: { week_day: 4, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedSutRadioBtn: { week_day: 5, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedSutRadioBtn: { week_day: 6, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" },
        selectedSunRadioBtn: { week_day: 7, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepover: null, pickup: "", return: "" }
      },
  ...
  resetSelectedDays = () => {
    const selectedDays = {
      selectedMunRadioBtn: { day: 1, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedTueRadioBtn: { day: 2, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedWedRadioBtn: { day: 3, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedThuRadioBtn: { day: 4, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedSutRadioBtn: { day: 5, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedSutRadioBtn: { day: 6, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" },
      selectedSunRadioBtn: { day: 7, parent_id: this.props.parentsID[0]['parent_id'], alternate: null, sleepOver: null, pickup: "", return: "" }
    }
  ...
  childrenInfo = () => {
    ...
    let index;
    arr.forEach((data, i) => {
      if (data.child_id == this.state.child_id) {
        index = i
      }
    })
  ...
  idChecked = (valueName, underValueName, value) => {
    let arr = Object.assign({}, this.state.selectedDays);
  ...
  render() {
    let parentCount = "";
    for (let i = 1; i <= this.props.parentsID.length; i++) {
      parentCount += `p${i}/ `;
    }
                ...
                {item.show &&
                  <View style={styles.modal}>
                    ...
                    <View style={Styles.FlexColumn}>
                      ...
                      <CheckBox
                        value={this.state.selectedDays[item.valName].alternate}
                        onValueChange={() => this.idChecked(item.valName, 'alternate', !this.state.selectedDays[item.valName].alternate)}
                      />
                    </View>
                    <View style={{ width: '20%' }}>
                    ...
                    <View style={Styles.FlexColumn}>
                      ...
                      <CheckBox
                        value={this.state.selectedDays[item.valName].sleepover}
                        onValueChange={() => this.idChecked(item.valName, 'sleepover', !this.state.selectedDays[item.valName].sleepover)}
                      />
                    </View>
                  </View>
                }
